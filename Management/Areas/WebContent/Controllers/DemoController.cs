...
namespace Management.Areas.WebContent.Controllers
{
    ...
    public class DemoController : BaseController
    {
            ...
            List<SelectTxt> relatedmoj = null)
        {
            ...
            tempData.ProcessDate = Services.Authorization.WebLevelManagementService.GetWEBNew(tempData.WEBNewsSN) == null ? System.DateTime.Now : Services.Authorization.WebLevelManagementService.GetWEBNew(tempData.WEBNewsSN).ProcessDate;
