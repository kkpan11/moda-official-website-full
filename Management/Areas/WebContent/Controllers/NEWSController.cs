    ...
    public class NEWSController : BaseController
    {
            ...
            )
        {
            try
            {
                ...
                wEBNews.PublishDate = DateTime.Now;
                ...
                var checkMissData = Services.CheckModel.CheckedData.CheckedWebNews(ref wEBNews, ref ckEditorurl, fileinfo, linkinfo , Transcript);
