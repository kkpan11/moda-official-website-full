...
namespace Management.Areas.WebContent.Controllers
{
    ...
    public class ScheduleController : BaseController
    {
            ...
            if (int.TryParse(key, out _key))
            {
                ...
                var NewsList = (from n in News
                                select new DBModel.WEBNews
                               {
                                ...
                                Title = n.Title == null ? n.Title : Regex.Replace(n.Title, "'", " "),
        ...
        public  IActionResult ScheduleSave (WEBNews wEBNews,List<int> wEBNewsSN, List<CommonFileModel> fileinfo = null, List<SelectTxt> relatedlink = null)
        {
            try
            {
                ...
                wEBNews.CreatedDate = DateTime.Now;
