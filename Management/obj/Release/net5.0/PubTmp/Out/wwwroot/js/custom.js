...
$(document).ready(function () {
    ...
    $(".right-side-toggle").on("click", function () {
        ...
        $(".fxhdr").on("click", function () {
            ...
            if (body.hasClass("fix-header")) {
                RightSidebar.fixHeader = "1";
            } else {
                RightSidebar.fixHeader = "0";
            };
        ...
        $(".fxsdr").on("click", function () {
            ...
            if (body.hasClass("fix-sidebar")) {
             //   RightSidebar.fixSidebar = "1";
            } else {
             //   RightSidebar.fixSidebar = "0";
            };
    ...
    $(function () {
        var set = function () {
            ...
            var titleOffset = ($('.row.bg-title').length)?$('.row.bg-title').height() + 17.5 + 90 : 60;
            if (width < 768) {
