...
namespace ModaMailBox.Controllers
{
    ...
    public class HomeController : BaseController
    {
        ...
        {
            caseApplyWeb.Title = "服務說明｜" + caseApplyWeb.Title;
            return View();
        }
        /// <summary>
        /// 認證電子信箱
        ...
        {
            caseApplyWeb.Title = "認證電子信箱｜" + caseApplyWeb.Title;
        ...
        {
            caseApplyWeb.Title = "案件已確認｜" + caseApplyWeb.Title;
            return View();
        }
        /// <summary>
        /// 填寫意見內容
        ...
        {
            caseApplyWeb.Title = "填寫意見內容｜" + caseApplyWeb.Title;
        ...
        {
            caseApplyWeb.Title = "確認意見內容｜" + caseApplyWeb.Title;
        ...
        {
            caseApplyWeb.Title = "案件已成立｜" + caseApplyWeb.Title;
            ConfirmationModel confirmationModel = new ConfirmationModel();
        ...
        {
            caseApplyWeb.Title = "查詢案件進度｜" + caseApplyWeb.Title;
        ...
        {
            caseApplyWeb.Title = "查詢進度結果頁｜" + caseApplyWeb.Title;
        ...
        {
            caseApplyWeb.Title = "重寄「案件受理通知信」｜" + caseApplyWeb.Title;
            return View();
        }
        #endregion
        ...
        public IActionResult Survey()
        {
            ...
            if (caseApplyWeb != null && !caseApplyWeb.Satisfaction)
            {
                surveymodel.Msg = "目前滿意度調查關閉中";
            }
        ...
        public IActionResult SurveySearch(string caseNo, string casePwd, string cfToken)
        {
            ...
            if (error.Count() == 0)
            {
                ...
                {
                    checkModel.errormsg = "案件尚在辦理中";
                }
                else if (MailBoxService.CheckSurveyExists(caseApply.CaseApplySN))
                {
                    checkModel.errormsg = "案件已填寫過問券調查";
                }
                else if ((caseApply.ReplySource == EnumTpye.GetEnumNumberToSting(Utility.MailBox.EnumReplySource.Speed) ? caseApply.ReplyDate : caseApply.ReplySource2Date).Value.AddDays(20) < DateTime.Now)
                {
        ...
        public IActionResult SaveSurvey(CaseApplySurvey survey, string cftoken)
        {
            ...
            {
                cmodel = new MailBox.checkmodel { errormsg = "目前滿意度調查關閉中", focusOn = "" };
                return StatusResult(System.Net.HttpStatusCode.BadRequest, cmodel);
            }
        ...
        {
            //var CaptchaCode = GetSession<string>("CaptchaCode");
            if (!GetTurnstileAsync(cftoken).GetAwaiter().GetResult())
            {
                return StatusResult(System.Net.HttpStatusCode.BadRequest, "驗證碼已失效，請重新送出");
            }
            else
            {
                ...
                data.EffectiveDate = DateTime.Now.AddHours(AddHours);
        ...
        public IActionResult QueryCase(CaseApply data, string cftoken)
        {
            ...
            if (caseApply == null)
            {
                checkmodel = new MailBox.checkmodel { errormsg = "查無資料", focusOn = "CaseNo" };
                return StatusResult(System.Net.HttpStatusCode.BadRequest, checkmodel);
            }
            else if (caseApply.AcceptDate == null)
            {
                if (caseApply.EffectiveDate < DateTime.Now)
                {
        ...
        public IActionResult ResendLetter(string email, string cftoken)
        {
            ...
            {
                return StatusResult(System.Net.HttpStatusCode.OK, "請查收案件成立信");
            }
            else
            {
                return StatusResult(System.Net.HttpStatusCode.BadRequest, errorMsg);
