...
//	var file = $(".filesList").val();
//	if(file == 0 ){
//		$(".text").html("未選擇任何檔案");
//	} else {
//		$(".text").html(file.replace(/C:\\fakepath\\/i, ''));
//	}
//})
//$(".filesList-2").change(function () {
//	var file2 = $(".filesList-2").val();
//	if(file2 == 0 ){
//		$(".text2").html("未選擇任何檔案");
//	} else {
//		$(".text2").html($(".filesList-2").val().replace(/C:\\fakepath\\/i, ''));
//	}
//})
//$(".filesList-3").change(function () {
//	var file3 = $(".filesList-3").val();
//	if(file3 == 0 ){
//		$(".text3").html("未選擇任何檔案");
//	} else {
//		$(".text3").html($(".filesList-3").val().replace(/C:\\fakepath\\/i, ''));
//	}
//})
//$(".filesList-4").change(function () {
//	var file4 = $(".filesList-4").val();
//	if(file4 == 0 ){
//		$(".text4").html("未選擇任何檔案");
//	} else {
//		$(".text4").html($(".filesList-4").val().replace(/C:\\fakepath\\/i, ''));
//	}
//})
//$(".filesList-5").change(function () {
//	var file5 = $(".filesList-5").val();
//	if(file5 == 0 ){
//		$(".text5").html("未選擇任何檔案");
//	} else {
//		$(".text5").html($(".filesList-5").val().replace(/C:\\fakepath\\/i, ''));
//	}
//})
//$(".filesList-6").change(function () {
//	var file6 = $(".filesList-6").val();
//	if(file6 == 0 ){
//		$(".text6").html("未選擇任何檔案");
//	} else {
//		$(".text6").html($(".filesList-6").val().replace(/C:\\fakepath\\/i, ''));
//	}
//})
//$(".filesList-7").change(function () {
//	var file7 = $(".filesList-7").val();
//	if(file7 == 0 ){
//		$(".text7").html("未選擇任何檔案");
//	} else {
//		$(".text7").html($(".filesList-7").val().replace(/C:\\fakepath\\/i, ''));
//	}
//})