...
namespace Services.CheckModel
{
    public class CheckedData
    {
        ...
        public static CheckedModel CheckedWebNews(ref WEBNews wEBNews, ref List<string> ckEditorurl, List<CommonFileModel> commonFileModels = null, List<WebLink> linkinfo = null, List<WEBNewsTranscript> wEBNewsTranscripts = null, List<WEBNewsExtend> webNewsExtend = null)
        {
            ...
            switch (enumModule)
            {
                case Utility.SysConst.Module.CP:
                    checkedModel = News.CheckData(ref wEBNews, ref ckEditorurl, commonFileModels, linkinfo);
                    break;
                case Utility.SysConst.Module.NEWS:
                    checkedModel = News.CheckData(ref wEBNews, ref ckEditorurl, commonFileModels, linkinfo, wEBNewsTranscripts);
                    break;
        ...
        public class News
        {
            ...
            /// <param name="commonFileModels"></param>
            /// <returns></returns>
            public static CheckedModel CheckData(ref WEBNews wEBNews, ref List<string> ckEditorurl, List<CommonFileModel> commonFileModels, List<WebLink> linkinfo, List<WEBNewsTranscript> wEBNewsTranscripts = null)
            {
                CheckedModel checkedModel = new CheckedModel();
                ...
                switch (iArticleType)
                {
                    case (int)Utility.SYSConst.Content.Type.PAGE: News.ChkDataByArticleType0(ref missData, ref wEBNews, ref ckEditorurl, commonFileModels, linkinfo); break;
                    case (int)Utility.SYSConst.Content.Type.LINK: News.ChkDataByArticleType2(ref missData, ref wEBNews, commonFileModels); break;
                    case (int)Utility.SYSConst.Content.Type.DOWNLOAD: News.ChkDataByArticleType1(ref missData, ref wEBNews, commonFileModels); break;
                    case (int)Utility.SYSConst.Content.Type.Transcript: News.ChkDataByArticleType10(ref missData, ref wEBNews, commonFileModels, linkinfo, wEBNewsTranscripts); break;
                }
                if (missData.Count > 0)
                {
                    checkedModel.chk = false;
            ...
            public static void ChkDataByArticleType0(ref List<string> missData, ref WEBNews wEBNews, ref List<string> ckEditorurl, List<CommonFileModel> commonFileModels = null, List<WebLink> linkinfo = null, List<ChkFileModel> chkFileModels = null)
            {
                ...
                //內容檢查
                if (string.IsNullOrWhiteSpace(wEBNews.ContentText)) missData.Add(Utility.sysConstTable.field.Error.Required(Utility.sysConstTable.field.news.Page.Content));
                else
                {
                    //ckeditor 檢查
            ...
            public static void ChkDataByArticleType2(ref List<string> missData, ref WEBNews wEBNews, List<CommonFileModel> commonFileModels = null, List<ChkFileModel> chkFileModels = null)
            {
                ...
                //連結檢查
                if (string.IsNullOrWhiteSpace(wEBNews.URL)) missData.Add(Utility.sysConstTable.field.Error.Required(Utility.sysConstTable.field.news.LINK.URL));
                //部門檢查
                if (string.IsNullOrWhiteSpace(wEBNews.DepartmentID)) missData.Add(Utility.sysConstTable.field.Error.Required(Utility.sysConstTable.field.news.Page.SysDepartment));
                //檢查發布日期及下架日期
                missData = CheckSDED(missData, wEBNews);
        ...
        public class Link
        {
            ...
            public static void ChkDataByArticleType2(ref List<string> missData, ref WEBNews wEBNews, List<CommonFileModel> commonFileModels)
            {
                ...
                //連結檢查
                if (string.IsNullOrWhiteSpace(wEBNews.URL)) missData.Add(Utility.sysConstTable.field.Error.Required(Utility.sysConstTable.field.link.Link.URL));
                //發布單位檢查
                if (string.IsNullOrWhiteSpace(wEBNews.DepartmentID)) missData.Add(Utility.sysConstTable.field.Error.Required(Utility.sysConstTable.field.Text.SysDepartment));
                #region 圖檢查
                List<ChkFileModel> chkFileModels = new List<ChkFileModel>() {
