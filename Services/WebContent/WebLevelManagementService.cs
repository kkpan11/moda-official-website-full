            ...
            try
            {
                using (var db = new MODAContext())
                {
                    ...
                    if (source != null)
                    {
                        ...
                        source.ProcessDate = DateTime.Now;
        ...
        public static void DeleteAericle(int key, string ProcessUserID, string ProcessIP)
        {
            using (var db = new MODAContext())
            {
                try
                {
                    ...
                    {
                        level.IsEnable = "-99";
                        level.ProcessDate = DateTime.Now;
                ...
                using (var db = new MODAContext())
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(isenable))
                    {
                        if (isenable == "1")
                        {
                            ...
                            Data = Data.Where(x => x.EndDate == null || x.EndDate > DateTime.Now);
                        }
                        ...
                        else
                        {
                            ...
                            Data = Data.Where(x => x.EndDate < DateTime.Now);
                        }
                    }
            ...
            try
            {
                using (var db = new MODAContext())
                {
                    ...
                    else
                    {
                        ...
                        //        langData.ProcessDate = DateTime.Now;
            ...
            try
            {
                using (var db = new MODAContext())
                {
                    ...
                    foreach (var s in ckEditorurl.Distinct())
                    {
                        ...
                        webCntLink.URL = s;
                        webCntLink.CreatedDate = DateTime.Now;
            ...
            using (var db = new MODAContext())
            {
                ...
                if (News.Count > 0)
                {
                    ...
                    foreach (var N in News)
                    {
                        ...
                        webLevelCustomizeTag.CreatedDate = DateTime.Now;
                        webLevelCustomizeTag.ProcessUserId = data.ProcessUserID;
                        webLevelCustomizeTag.ProcessDate = DateTime.Now;
