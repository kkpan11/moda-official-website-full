...
builder.Services.AddSwaggerGen(c =>
    {
        c.SwaggerDoc("1.0", new Microsoft.OpenApi.Models.OpenApiInfo { Title = "计祇场API", Version = "1.0" });
...
{
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/1.0/swagger.json", "计祇场API 1.0"));
}
...
app.MapFallback(async (ctx) =>
{
   ...
   // await ctx.Response.SendFileAsync(name);
});
